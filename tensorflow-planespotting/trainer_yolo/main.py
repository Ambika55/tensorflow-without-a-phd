...
def main(argv):
    ...
    parser.add_argument('--hp-first-layer-filter-depth', default=128, type=int, help='Hyperparameter: the number of filters in the first and last layers')
    parser.add_argument('--hp-depth-increment', default=8, type=int, help='Hyperparameter: increment the decrement filter depth by this amount between first and last layer')
